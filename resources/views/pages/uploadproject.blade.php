            ...
            <div class="bg-white p-5 rounded-4 shadow-lg" style="max-width: 700px; margin: 0 auto; border: 1px solid #e0e0e0;">
                ...
                <form method="POST" action="{{ route('store') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control shadow-sm" name="title" id="projectTitle" placeholder="Enter project title">
                  ...
                  <!-- Group Name -->
                  <div class="form-floating mb-4">
                    <input type="text" class="form-control shadow-sm" name="g_name" id="groupName" placeholder="Enter group name">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="file" class="form-control shadow-sm"  name="file" id="capstoneFile">
                  </div>
