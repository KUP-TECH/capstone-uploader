<x-basecomponent>
    <style>
      ...
      .footer-overlay {
        ...
        bottom: 0;
        width: 100%;
        background-color: rgba(46, 125, 85, 0.95);
        color: white;
        text-align: center;
        padding: 15px 0;
        z-index: 2;
    ...
    <div class="container custom-container d-flex flex-wrap justify-content-center text-center py-4 px-2">
      <div class="row gx-5">
        <div class="col d-flex justify-content-center mb-3">
          <button type="button" class="btn btn-primary">List of Capstone</button>
        </div>
        <div class="col d-flex justify-content-center mb-3">
          <button type="button" class="btn btn-primary">Upload a Project</button>
        </div>
      </div>
    </div>
